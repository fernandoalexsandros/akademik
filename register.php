  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <b>Akademik Mahasiswa</b>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <b><p class="login-box-msg">Register Form</p></b>
        <form action="vl_user.php" method="post">
          ...
          <div class="form-group has-feedback">
           ...
           <div class="form-group has-feedback">
            <input type="password" name="Password" class="form-control" placeholder="Retype Password" maxlength="255" />
            <span class="form-control-feedback"><i class="fa fa-unlock"></i></span>
          </div>
        ...
        <a href="index.php"><i class="fa fa-users"></i>Back</a>

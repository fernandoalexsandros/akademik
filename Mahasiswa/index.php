    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li><a href="print.php"><i class="fa fa-book"></i><span>Print Jadwal</span></a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					...
					<center><h4><b>Made with <strong><i class="fa fa-code"></i> by Fernando Alexsandro Siregar in Bandung, West Java Indonesia</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">

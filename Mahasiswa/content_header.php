<header class="main-header">
  <!-- Logo -->
  <div class="logo">
<span class="logo-mini"><img src="../aset/foto/mahasiswa.png" class="img-circle" alt="Logo" height="50" width="50"></span>
<span class="logo-lg"><b>SSO Akademik</b></span>
</div>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <p>Welcome To Akademik Mahasiswa</p>
            </li>
            <!-- Menu Footer-->

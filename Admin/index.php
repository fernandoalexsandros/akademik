            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					...
					<center><h2><b>Akademik Developer Copyright &copy;  <?php echo date ('Y') ?></b></h2></center>
					<center><h4><b>Made by Fernando Alexsandro Siregar in Purwakarta, West Java Indonesia</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
